...
from StockPredictor import StockPredictor, ParseData, PlotData, PlotTestData
...
if __name__ == "__main__":
    #Main(sys.argv[1:])
    p, n = Main(['/home/lanhnguyen/workspace/pythonml-master/table.csv', '2016-11-14', '2016-11-18', 'D'])